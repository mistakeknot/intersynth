...
## North Star
Advance intersynth through small, testable changes aligned to its core mission: Multi-agent synthesis engine — collects findings from parallel review/research agents, deduplicates, writes verdicts, produces compact summaries. Keeps agent output out of the host context.
